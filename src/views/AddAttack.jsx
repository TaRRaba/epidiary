    ...
    <Layout user={user}>
      <div className="flex justify-center mt-10">
        <div name="attackForm" className="attackForm bg-white">
          <div>
            <h2 className="text-2xl mb-5">Добавление приступа</h2>
            <p>
              Дата:
              {' '}
              {date}
          ...
          <div className="mandatoryQues1 my-3">
            ...
            <input required className="question1Input visibility: hidden ml-3" type="date" />
          </div>
          ...
          <div className="additionalInfo visibility: hidden my-3">
            ...
            <h2 className="text-xl">Информация о приступах</h2>

            <div className="my-3">
              <p>3. Предчувствуете ли Вы начало приступа?</p>
              <select className="question3Select">
                <option value="">Выбрать вариант</option>
                <option value="Да">Да</option>
                <option value="Нет">Нет</option>
                <option value="Свой вариант">Свой вариант</option>
              </select>
              <input className="question3Input visibility: hidden ml-3" type="text" />
            </div>
            ...
            <div className="my-3">
              ...
              <input className="question5Input box-content w-12 h-4 mr-2" type="number" />
              <span>минут</span>
            </div>
            <div className="my-3">
              <p>
            ...
            <div className="my-3">
              ...
              <select className="question11Select">
                <option value="">Выбрать вариант</option>
                <option value="Да">Да</option>
                <option value="Нет">Нет</option>
                <option value="Не уверен">Не уверен(a)</option>
            ...
            <div className="my-3">
              ...
              <select className="question12Select">
                <option value="">Выбрать вариант</option>
              ...
              <br />
              <input className="question12Input visibility: hidden my-3" type="text" />
            </div>
            ...
            <div className="my-3">
              ...
              <select className="question13Select">
                <option value="">Выбрать вариант</option>
                <option value="Да">Да</option>
                <option value="Нет">Нет</option>
                <option value="Не уверен">Не уверен(a)</option>
            ...
            <div className="my-3">
              ...
              <input className="question14Input" type="text" />
            </div>
            ...
            <div className="my-3">
              ...
              <select className="question16Select">
                <option value="">Выбрать вариант</option>
            ...
            <div className="my-3">
              ...
              <select className="question17Select">
                <option value="">Выбрать вариант</option>
              ...
              <input className="question17Input visibility: hidden ml-3" type="text" />
            </div>
            ...
            <div className="my-3">
              ...
              <select className="question18Select">
                <option value="">Выбрать вариант</option>
              ...
              <input className="question18Input visibility: hidden ml-3" type="text" />
            </div>
            ...
            <div className="my-3">
              ...
              <select className="question19Select">
                <option value="">Выбрать вариант</option>
            ...
            <div className="my-3">
              ...
              <select className="question20Select">
                <option value="">Выбрать вариант</option>
                <option value="Карбамазепин 100 мг">Карбамазепин 100 мг</option>
                <option value="Карбамазепин 200 мг">Карбамазепин 200 мг</option>
                <option value="Леветирацетам 200 мг">Леветирацетам 200 мг</option>
              ...
              <input className="question20Input visibility: hidden ml-3" type="text" />
            </div>

          </div>

          <div className="flex my-3">
            <button data-cancel="cancel" type="button" className="ml-2 flex cursor-pointer text-[#4520aa] items-center gap-x-1 rounded-md border py-2 px-4 hover:bg-[#4520aa] hover:text-white">Отменить</button>
            <button data-save="save" type="button" className="ml-2 flex cursor-pointer text-[#4520aa] items-center gap-x-1 rounded-md border py-2 px-4 hover:bg-[#4520aa] hover:text-white">Сохранить</button>
          </div>
